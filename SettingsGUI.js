...
function initializeAllSettings() {
    ...
    createSetting('fastallocateMult', 'Fast Allocate Multiplier', 'Multiplier used for Fast Allocate. Higher number makes it faster but sacrafices percision. ', 'value', 10, null, "Core");

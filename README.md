...
Step 2:  
Click this link: https://github.com/ExterminatorX99/AutoTrimps/raw/gh-pages/user.js  
...
script.src = 'https://ExterminatorX99.github.io/AutoTrimps/AutoTrimps2.js';
...
### Steam
Step 1:  
Go to this link to open the mods.js file on Github: <a href="https://github.com/ExterminatorX99/AutoTrimps/blob/gh-pages/mods.js">mods.js</a>  
...
Step 2: 
Click this link: https://github.com/ExterminatorX99/AutoTrimps/blob/gh-pages/GraphsOnly.user.js  
...
script.src = 'https://ExterminatorX99.github.io/AutoTrimps/GraphsOnly.js';
script.setAttribute('crossorigin',"anonymous");
document.head.appendChild(script);
```  
Press F12 inside the game, this opens the console, and paste the text into it and hit enter, this will load the script. You will have to do this everytime you refresh the game though so I recommend getting tampermonkey to do it for you!  
...
### Steam
Step 1:  
Go to this link to open the modsGRAPH.js file on Github: <a href="https://github.com/ExterminatorX99/AutoTrimps/blob/gh-pages/modsGRAPH.js">modsGRAPH.js</a>  
